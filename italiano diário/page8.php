...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=P6TGPZ"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=P6TGPZ" type="text/css">
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu2 cid-uk6zonw9HU" once="menu" id="menu02-1f">
...
<section data-bs-version="5.1" class="header1 cid-uk6zoo0owU" id="header1-1g">
        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-12 col-lg-6 col-md-6 title">
                <div class="title-wrapper">
                    <h2 class="mbr-section-title mbr-fonts-style display-1"><strong>Trascrivi</strong><br><strong> l'audio</strong></h2>
            ...
            <div class="col-12 col-lg-10">
                <div class="title-wrapper">
                    <h3 class="mbr-section-title mbr-fonts-style display-4">
                        <strong>Trascrivi l'audio</strong>
                    </h3>
                </div>
            ...
            <button type="button" onclick="checkAnswers()">Verifica</button>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingTwo">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse2_47" aria-expanded="false" aria-controls="collapse2">
                                <h4 class="panel-title-edit mbr-fonts-style display-7">
                        ...
                        <div id="collapse2_47" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_47">
                            <div class="panel-body">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingThree">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse3_47" aria-expanded="false" aria-controls="collapse3">
                                <h4 class="panel-title-edit mbr-fonts-style display-7">
                        ...
                        <div id="collapse3_47" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_47">
                            <div class="panel-body">
                                <p class="mbr-fonts-style panel-text display-4">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingFour">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse4_47" aria-expanded="false" aria-controls="collapse4">
                                <h4 class="panel-title-edit mbr-fonts-style display-7">
                        ...
                        <div id="collapse4_47" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_47">
                            <div class="panel-body">
                                <p class="mbr-fonts-style panel-text display-4">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingFive">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse5_47" aria-expanded="false" aria-controls="collapse5">
                                <h4 class="panel-title-edit mbr-fonts-style display-7">
                        ...
                        <div id="collapse5_47" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_47">
                            <div class="panel-body">
                                <p class="mbr-fonts-style panel-text display-4">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingSix">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse6_47" aria-expanded="false" aria-controls="collapse6">
                                <h4 class="panel-title-edit mbr-fonts-style display-7">
                        ...
                        <div id="collapse6_47" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_47">
                            <div class="panel-body">
                                <p class="mbr-fonts-style panel-text display-4">
...
<section data-bs-version="5.1" class="footer3 cid-uk6zooWHE4" once="footers" id="footer03-1i">
