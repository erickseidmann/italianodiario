            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
					...
					<li class="nav-item dropdown">
						<a class="nav-link link text-black text-primary dropdown-toggle display-4" href="page2.php" data-toggle="dropdown-submenu" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Atividades</a><div class="dropdown-menu" aria-labelledby="dropdown-580"><a class="text-black text-primary dropdown-item display-4" href="../atividadeplurais/">Plurale</a><a class="text-black text-primary dropdown-item display-4" href="">Completa le frasi</a><a class="text-black text-primary dropdown-item display-4" href="">Vero o falso</a><a class="text-black text-primary dropdown-item display-4" href="">Completa il testo</a><a class="text-black text-primary dropdown-item display-4" href="../trascriviaudio/">Trascrivi l'audio</a></div>
					</li></ul>
