                ...
                <div class="item">
                   ...
                   <h5 class="item-title mbr-fonts-style display-5"><strong>Transforma Questi</strong></h5>
                    ...
                    <div class="item-content">
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="page5.html" class="btn item-btn btn-lg btn-primary-outline display-7">Iniziare</a></div>
                    </div>
                ...
                <div class="item">
                   ...
                   <h5 class="item-title mbr-fonts-style display-5"><strong>Completa le Frasi</strong></h5>
                    ...
                    <div class="item-content">
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="page6.html" class="btn item-btn btn-lg btn-primary-outline display-7">Iniziare</a></div>
                    </div>
                ...
                <div class="item">
                   ...
                   <h5 class="item-title mbr-fonts-style display-5"><strong>Scegli tra le Opzioni&nbsp;</strong></h5>
                    ...
                    <div class="item-content">
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="page7.html" class="btn item-btn btn-lg btn-primary-outline display-7">Iniziare</a></div>
                    </div>
                ...
                <div class="item">
                   ...
                   <h5 class="item-title mbr-fonts-style display-5"><strong>Trascrivi l'audio</strong></h5>
                    ...
                    <div class="item-content">
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="page8.html" class="btn item-btn btn-lg btn-primary-outline display-7">Iniziare</a></div>
                    </div>
                </div>
            </div>
        </div>
